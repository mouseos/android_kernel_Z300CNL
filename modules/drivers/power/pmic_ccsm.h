...
#define PMIC_A0_WAR 1

#define TLP2INSTMEMADDR_REG		0x76
#define TLP2INSTMEMDATA_REG		0x77
#define TLP2INSTMEMADDR_VALUE		0x26
#define TLP2INSTMEMDATA_VALUE		0x1c
...
struct pmic_chrgr_drv_context {
	...
	struct delayed_work as_irq_work;
#endif
