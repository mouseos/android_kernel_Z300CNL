...
#define OV2680_INTEGRATION_TIME_MARGIN	5
...
#define OV2680_SC_CMMN_SCCB_ID			0x300C
...
#define OV2680_MWB_RED_GAIN_H		0x5004
#define OV2680_MWB_GREEN_GAIN_H		0x5006
#define OV2680_MWB_BLUE_GAIN_H		0x5008
#define OV2680_MWB_GAIN_MAX			0x0fff


#define OV2680_H_CROP_START_H			0x3800
#define OV2680_H_CROP_START_L			0x3801
#define OV2680_V_CROP_START_H			0x3802
#define OV2680_V_CROP_START_L			0x3803
#define OV2680_H_CROP_END_H			0x3804
#define OV2680_H_CROP_END_L			0x3805
#define OV2680_V_CROP_END_H			0x3806
#define OV2680_V_CROP_END_L			0x3807
#define OV2680_H_OUTSIZE_H			0x3808
#define OV2680_H_OUTSIZE_L			0x3809
#define OV2680_V_OUTSIZE_H			0x380a
#define OV2680_V_OUTSIZE_L			0x380b
...
static struct ov2680_reg const ov2680_1616x1216_30fps[] = {
	...
	{OV2680_8BIT, 0x3082, 0x45}, /*MCLK=19.2Mhz*/
	...
	{OV2680_8BIT, 0x3801, 0x00}, /* H crop start: 0 */
	{OV2680_8BIT, 0x3802, 0x00},
	{OV2680_8BIT, 0x3803, 0x00}, /* V crop start: 0 */
	{OV2680_8BIT, 0x3804, 0x06},
	{OV2680_8BIT, 0x3805, 0x4f}, /* H crop end:  1615 */
	{OV2680_8BIT, 0x3806, 0x04},
	{OV2680_8BIT, 0x3807, 0xbf}, /* V crop end:  1215 */
	{OV2680_8BIT, 0x3808, 0x06},
	{OV2680_8BIT, 0x3809, 0x50}, /* H output size: 1616 */
	{OV2680_8BIT, 0x380a, 0x04},
	{OV2680_8BIT, 0x380b, 0xc0}, /* V output size: 1216 */

	/* H blank timing */
	{OV2680_8BIT, 0x380c, 0x06},
	{OV2680_8BIT, 0x380d, 0xa4}, /* H total size: 1700 */
	{OV2680_8BIT, 0x380e, 0x05},
	{OV2680_8BIT, 0x380f, 0x0e}, /* V total size: 1294 */
	{OV2680_8BIT, 0x3810, 0x00},
	{OV2680_8BIT, 0x3811, 0x00}, /* H window offset: 0 */
	{OV2680_8BIT, 0x3812, 0x00},
	{OV2680_8BIT, 0x3813, 0x00}, /* V window offset: 0 */
	...
	{OV2680_8BIT, 0x5794, 0x03},
        {OV2680_8BIT, 0x4201, 0x00},
        {OV2680_8BIT, 0x4202, 0x05},
	/*
	{OV2680_8BIT, 0x5708, 0x01},    //enable manual_win
	{OV2680_8BIT, 0x5704, 0x06},    //output_x_size, set as r3808/r3809
	{OV2680_8BIT, 0x5705, 0x50},
	{OV2680_8BIT, 0x5706, 0x04},    //output_y_size, set as r380a/r380b
...
static struct ov2680_reg const ov2680_1616x916_30fps[] = {
	...
	{OV2680_8BIT, 0x3805, 0x4f}, /* H crop end:  1615 */
	{OV2680_8BIT, 0x3806, 0x04},
	{OV2680_8BIT, 0x3807, 0x31}, /* V crop end:  1585 */
	{OV2680_8BIT, 0x3808, 0x06},
	{OV2680_8BIT, 0x3809, 0x50}, /* H output size: 1616 */
	{OV2680_8BIT, 0x380a, 0x03},
	{OV2680_8BIT, 0x380b, 0x94}, /* V output size: 916 */
	...
	{OV2680_8BIT, 0x3811, 0x00}, /* H window offset: 0 */
	{OV2680_8BIT, 0x3812, 0x00},
	{OV2680_8BIT, 0x3813, 0x00}, /* V window offset: 8 */
	{OV2680_8BIT, 0x3814, 0x11},
	{OV2680_8BIT, 0x3815, 0x11},
	{OV2680_8BIT, 0x3819, 0x04},
	{OV2680_8BIT, 0x3820, 0xc0},
	...
	{OV2680_8BIT, 0x5793, 0x00},
	{OV2680_8BIT, 0x5794, 0x03},
	{OV2680_8BIT, 0x3803, 0x8e},
	{OV2680_8BIT, 0x3806, 0x04},
	{OV2680_8BIT, 0x3807, 0x31},
	{OV2680_8BIT, 0x380a, 0x03},
...
static struct ov2680_reg const ov2680_1296x736_48fps[] = {
	{OV2680_8BIT, 0x0103, 0x01},
	{OV2680_8BIT, 0x3002, 0x00},
	{OV2680_8BIT, 0x3016, 0x1c},
	{OV2680_8BIT, 0x3018, 0x44},
	...
	{OV2680_8BIT, 0x3789, 0x60}, 
	{OV2680_8BIT, 0x3800, 0x00},
	{OV2680_8BIT, 0x3801, 0xa0}, /* H crop start: 322 */
	{OV2680_8BIT, 0x3802, 0x00},
	{OV2680_8BIT, 0x3803, 0xf2}, /* V crop start: 32 */
	{OV2680_8BIT, 0x3804, 0x05},
	{OV2680_8BIT, 0x3805, 0xaf}, /* H crop end:  1685 */
	{OV2680_8BIT, 0x3806, 0x03},
	{OV2680_8BIT, 0x3807, 0xcd}, /* V crop end:  1063 */
	{OV2680_8BIT, 0x3808, 0x05},
	{OV2680_8BIT, 0x3809, 0x00}, /* H output size: 336 */
	{OV2680_8BIT, 0x380a, 0x02},
	{OV2680_8BIT, 0x380b, 0xd0}, /* V output size: 256 */

	/* H blank timing */
	{OV2680_8BIT, 0x380c, 0x05},
	{OV2680_8BIT, 0x380d, 0xa6}, /* H total size: 2048 */
	{OV2680_8BIT, 0x380e, 0x02},
	{OV2680_8BIT, 0x380f, 0xf8}, /* V total size: 1184 */
	{OV2680_8BIT, 0x3810, 0x00},
	{OV2680_8BIT, 0x3811, 0x08}, /* H window offset: 5 */
	{OV2680_8BIT, 0x3812, 0x00},
	{OV2680_8BIT, 0x3813, 0x06}, /* V window offset: 2 */
	{OV2680_8BIT, 0x3814, 0x11},
	{OV2680_8BIT, 0x3815, 0x11},
	{OV2680_8BIT, 0x3819, 0x04},
	{OV2680_8BIT, 0x3820, 0xc0},
	...
	{OV2680_8BIT, 0x5793, 0x00},
	{OV2680_8BIT, 0x3800, 0x00},
	{OV2680_8BIT, 0x3801, 0x98},
	{OV2680_8BIT, 0x3802, 0x00},
	{OV2680_8BIT, 0x3803, 0xea},
	{OV2680_8BIT, 0x3804, 0x05},
	{OV2680_8BIT, 0x3805, 0xb7},
	{OV2680_8BIT, 0x3806, 0x03},
	{OV2680_8BIT, 0x3807, 0xd5},
	{OV2680_8BIT, 0x3808, 0x05},
	{OV2680_8BIT, 0x3809, 0x10},
	{OV2680_8BIT, 0x380a, 0x02},
	{OV2680_8BIT, 0x380b, 0xe0},
	{OV2680_8BIT, 0x380c, 0x06},
	{OV2680_8BIT, 0x380d, 0xec},
	{OV2680_8BIT, 0x380e, 0x03},
	{OV2680_8BIT, 0x380f, 0x08},
        {OV2680_8BIT, 0x4201, 0x00},
        {OV2680_8BIT, 0x4202, 0x05},
	{OV2680_TOK_TERM, 0, 0},
...
static struct ov2680_reg const ov2680_1096x736_48fps[] = {
	{OV2680_8BIT, 0x0103, 0x01},
	{OV2680_8BIT, 0x3002, 0x00},
	{OV2680_8BIT, 0x3016, 0x1c},
	{OV2680_8BIT, 0x3018, 0x44},
	...
	{OV2680_8BIT, 0x5793, 0x00},
	{OV2680_8BIT, 0x3800, 0x00},
	{OV2680_8BIT, 0x3801, 0xfc},
	{OV2680_8BIT, 0x3802, 0x00},
	{OV2680_8BIT, 0x3803, 0xea},
	{OV2680_8BIT, 0x3804, 0x05},
	{OV2680_8BIT, 0x3805, 0x53},
	{OV2680_8BIT, 0x3806, 0x03},
	{OV2680_8BIT, 0x3807, 0xd5},
	{OV2680_8BIT, 0x3808, 0x04},
	{OV2680_8BIT, 0x3809, 0x48},
	{OV2680_8BIT, 0x380a, 0x02},
	{OV2680_8BIT, 0x380b, 0xe0},
	{OV2680_8BIT, 0x380c, 0x06},
	{OV2680_8BIT, 0x380d, 0xec},
...
struct ov2680_resolution ov2680_res_preview[] = {
	{
		.desc = "THIS IS PREVIEW:ov2680_1616x1216_30fps",
		.width = 1616,
		.height = 1216,
		.pix_clk_freq = 66,
		.fps = 30,
	...
	{
		.desc = "THIS IS PREVIEW:ov2680_1616x916_30fps",
		.width = 1616,
		.height = 916,
		.pix_clk_freq = 66,
		.fps = 30,
...
struct ov2680_resolution ov2680_res_still[] = {
	
	{
			.desc = "THIS IS STILL:ov2680_1616x1216_30fps",
			.width = 1616,
			.height = 1216,
			.pix_clk_freq = 66,
			.fps = 30,
		...
		{
			.desc = "THIS IS STILL:ov2680_1616x916_30fps",
			.width = 1616,
			.height = 916,
			.pix_clk_freq = 66,
			.fps = 30,
...
struct ov2680_resolution ov2680_res_video[] = {
	{
		.desc = "THIS IS VIDEO:ov2680_1616x1216_30fps",
		.width = 1616,
		.height = 1216,
		.pix_clk_freq = 66,
		.fps = 30,
	...
	{
		.desc = "THIS IS VIDEO:ov2680_1296x736_48fps",
		.width = 1296,
		.height = 736,
		.pix_clk_freq = 66,
		.fps = 48,
		.used = 0,
		.pixels_per_line = 1562,
		.lines_per_frame = 776,
		.bin_factor_x = 1,
		.bin_factor_y = 1,
		.bin_mode = 0,
		.regs = ov2680_1296x736_48fps,
		.skip_frames = 0,
	},
	{
		.desc = "THIS IS VIDEO:ov2680_1096x736_48fps",
		.width = 1096,
		.height = 736,
		.pix_clk_freq = 66,
		.fps = 48,
