...
static struct ov5693_reg const ov5693_init_setting[] = {
	...
	{OV5693_8BIT, 0x4512, 0x01},	/* bit[0] Vertical binning option: 0:sum, 1:average */
...
/*
 * FULL QSXGA (2592x1944) 30fps 0.6ms VBlank 2lane 10Bit
 */
static struct ov5693_reg const ov5693_5M_30fps[] = {
...
static struct ov5693_reg const ov5693_1080p_30fps[] = {
	...
	{OV5693_8BIT, 0x3808, 0x07},	/* x output size: 1936 */
...
static struct ov5693_reg const ov5693_720p_30fps[] = {
	{OV5693_8BIT, 0x3501, 0x7b},
	{OV5693_8BIT, 0x3502, 0x00},
	{OV5693_8BIT, 0x3600, 0xbc},
	{OV5693_8BIT, 0x3620, 0x44},
	{OV5693_8BIT, 0x3621, 0xb5},
	{OV5693_8BIT, 0x3622, 0x0c},
	...
	{OV5693_8BIT, 0x3810, 0x00},	/* x offset: 8 */
	{OV5693_8BIT, 0x3811, 0x08},
	{OV5693_8BIT, 0x3812, 0x00},	/* y offset: 2+118 */
	{OV5693_8BIT, 0x3813, 0x78},
	{OV5693_8BIT, 0x3814, 0x31},
	{OV5693_8BIT, 0x3815, 0x31},
	{OV5693_8BIT, 0x3820, 0x01},	/* bit[0]: vertical binning */
	{OV5693_8BIT, 0x3821, 0x1f},	/* bit[0]: horizontal binning */
	{OV5693_8BIT, 0x5002, 0x00},
	{OV5693_8BIT, 0x5780, 0xfc},	/* DPC control registers */
	{OV5693_8BIT, 0x5781, 0x13},
	{OV5693_8BIT, 0x5782, 0x03},
	{OV5693_8BIT, 0x5786, 0x20},
	{OV5693_8BIT, 0x5787, 0x40},
	{OV5693_8BIT, 0x5788, 0x08},
	{OV5693_8BIT, 0x5789, 0x08},
	{OV5693_8BIT, 0x578a, 0x02},
	{OV5693_8BIT, 0x578b, 0x01},
	{OV5693_8BIT, 0x578c, 0x01},
	{OV5693_8BIT, 0x578d, 0x0c},
	{OV5693_8BIT, 0x578e, 0x02},
	{OV5693_8BIT, 0x578f, 0x01},
	{OV5693_8BIT, 0x5790, 0x01},
	{OV5693_TOK_TERM, 0, 0}
};
...
static struct ov5693_reg const ov5693_QCIF_30fps[] = {
	...
	{OV5693_8BIT, 0x3806, 0x07},	/* y_addr_end: 1955 */
	{OV5693_8BIT, 0x3807, 0xa3},
	{OV5693_8BIT, 0x3808, 0x00},	/* x output size: 192 */
	{OV5693_8BIT, 0x3809, 0xc0},
	{OV5693_8BIT, 0x380a, 0x00},	/* y output size: 160 */
...
struct ov5693_resolution ov5693_res_preview[] = {
	...
	{
		.desc = "ov5693_720p_30fps_preview",
		.width = 1296,
		.height = 736,
		.fps = 30,
		.pix_clk_freq = 160,
	...
	{
		.desc = "ov5693_1080P_30fps_preview",
		.width = 1936,
		.height = 1096,
		.fps = 30,
		.pix_clk_freq = 160,
