...
#define AR0543_FUSEID_START_ADDR        0x31f4
...
#define AR0543_OTP_DATA_SIZE            0x60
...
static const struct ar0543_reg ar0543_reset_register[] = {
        ...
        {AR0543_16BIT,{0x301A},0x0618},// RESET_REGISTER
        ...
        {AR0543_16BIT,{0x31B4},0x0ED7},// MIPI_TIMING_0
        ...
        //ADACD: low gain
        {AR0543_16BIT,{0x3100},0x0000},// ADACD_CONTROL
...
static struct ar0543_reg const ar0543_2592x1488_14fps[] = {
        //[2592*1944 @15FPS]
        {AR0543_8BIT,{0x0104}, 0x01},   // GROUPED_PARAMETER_HOLD = 0x1
        ...
        {AR0543_16BIT,{0x0404}, 0x0010},   // scale_m
        {AR0543_16BIT,{0x034C}, 0x0A20},   // Output Width
        {AR0543_16BIT,{0x034E}, 0x05D0},   // Output Height
        {AR0543_16BIT,{0x0344}, 0x0008},   // Column Start
        {AR0543_16BIT,{0x0346}, 0x00EC},   // Row Start
        {AR0543_16BIT,{0x0348}, 0x0A27},   // Column End
        {AR0543_16BIT,{0x034A}, 0x06BB},   // Row End
        {AR0543_16BIT,{0x3040}, 0x0041},   // Read Mode
        {AR0543_16BIT,{0x3010}, 0x00A0},   // Fine Correction
        {AR0543_16BIT,{0x3012}, 0x0840},   // Coarse Integration Time
        {AR0543_16BIT,{0x3014}, 0x02CE},   // Fine Integration Time
        {AR0543_16BIT,{0x0340}, 0x0841},   // Frame Lines
        {AR0543_16BIT,{0x0342}, 0x0ECA},   // Line Length
...
static struct ar0543_reg const ar0543_1080p_30fps[] = {
        ...
        {AR0543_16BIT,{0x0344}, 0x0150},   // Column Start
        {AR0543_16BIT,{0x0346}, 0x01B0},   // Row Start
        {AR0543_16BIT,{0x0348}, 0x08DF},   // Column End
        {AR0543_16BIT,{0x034A}, 0x05F7},   // Row End
        {AR0543_16BIT,{0x3040}, 0x0041},   // Read Mode
        {AR0543_16BIT,{0x3010}, 0x00A0},   // Fine Correction
...
static struct ar0543_reg const ar0543_960p_28fps[] = {
        //[1296*976 @28FPS]
        {AR0543_8BIT,{0x0104}, 0x01},   // GROUPED_PARAMETER_HOLD = 0x1
        ...
        {AR0543_16BIT,{0x3012}, 0x04F5},   // Coarse Integration Time
        {AR0543_16BIT,{0x3014}, 0x05F8},   // Fine Integration Time
        {AR0543_16BIT,{0x0340}, 0x04F6},   // Frame Lines
        {AR0543_16BIT,{0x0342}, 0x0C4E},   // Line Length
...
static struct ar0543_reg const ar0543_720p_30fps[] = {
        ...
        {AR0543_16BIT,{0x0344}, 0x0008},   // Column Start
        {AR0543_16BIT,{0x0346}, 0x00F8},   // Row Start
        {AR0543_16BIT,{0x0348}, 0x0A25},   // Column End
        {AR0543_16BIT,{0x034A}, 0x06B5},   // Row End
        {AR0543_16BIT,{0x3040}, 0x04C3},   // Read Mode
        {AR0543_16BIT,{0x3010}, 0x0184},   // Fine Correction
        {AR0543_16BIT,{0x3012}, 0x04A0},   // Coarse Integration Time
        {AR0543_16BIT,{0x3014}, 0x05F8},   // Fine Integration Time
        {AR0543_16BIT,{0x0340}, 0x04A1},   // Frame Lines
        {AR0543_16BIT,{0x0342}, 0x0C4E},   // Line Length
...
static struct ar0543_resolution ar0543_res_preview[] = {
        {
                 ...
                 .bin_factor_y =         1,
                 .skip_frames = 1,
                 .mipi_freq = 672000, /* mipi frequency in KHz */
        },
        {
                 .desc =        "PREVIEW_960p_28fps"    ,
                 .width =       1296    ,
                 .height =      976     ,
                 .fps =         28      ,
                 .used =        0       ,
        ...
        {
                 // For 2560x1440 output
                 .desc =        "PREVIEW_2592x1488_14fps" ,
                 .width =       2592    ,
                 .height =      1488    ,
                 .fps =         14      ,
                 .used =        0       ,
                 .pixels_per_line = 0x0ECA, /* consistent with regs arrays */
                 .lines_per_frame = 0x0841, /* consistent with regs arrays */
                 .regs =        ar0543_2592x1488_14fps,
                 .bin_factor_x =        0,
                 .bin_factor_y =        0,
                 .skip_frames = 1,
                 .mipi_freq = 672000, /* mipi frequency in KHz */
