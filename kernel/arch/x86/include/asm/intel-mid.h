...
struct sfi_table_oem1 {
	struct sfi_table_header header;
	u8	ifwi_rc;		/* 0: shipping version, 0xff: factory version*/
	u8      hardware_id;            /* hardware revision */
	u8      project_id;             /* project identification */
	u8      lcd_id;                 /* display panel variants */
	u8      touch_id;               /* touch panel variants */
	u8      camera_front_id;       /* front camera variants */
	u8      camera_rear_id;         /* rear camera variants */
	u8      rf_sku;
	u8      ddr_id;
} __packed;

struct sfi_table_oem1_1 {
	struct sfi_table_header header;
	u8	ifwi_rc;		/* 0: shipping version, 0xff: factory version*/
	u8      hardware_id;		/* hardware revision */
	u8      project_id;		/* project identification */
	u8      sub_project_id;		/* sub_project identification */
	u8      lcd_id;			/* display panel variants */
	u8      touch_id;		/* touch panel variants */
	u8      cardiz_id;		/* cardiz variants */
	u8      camera_front_id;	/* front camera manufacturing variants */
	u8      camera_rear_id;		/* rear camera manufacturing variants*/
	u8      wifi_id;		/* wifi varinats */
	u8      rf_sku;
} __packed;
