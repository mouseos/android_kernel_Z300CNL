...
#include "device_libs/platform_gt9271.h"
#include "device_libs/platform_atmel_mxt1666t2.h"
#include "device_libs/platform_focal_ft5826s.h"
#include "device_libs/platform_gauge_bq27520.h"
...
struct devs_id __initconst device_ids[] = {
...
#ifdef Z300CL
	{"hpa02254_batt", SFI_DEV_TYPE_I2C, 1, &no_platform_data, NULL},
	{"smb347_charger", SFI_DEV_TYPE_I2C, 1, &no_platform_data, NULL},
#endif
	{"cxd4756gf", SFI_DEV_TYPE_I2C, 0, &no_platform_data, NULL},
	...
	//{"hx8528", SFI_DEV_TYPE_I2C, 0, &hx8528_platform_data},
        {"gt9271", SFI_DEV_TYPE_I2C, 0, &gt9271_platform_data, NULL},
        {"atmel_mxt1666t2", SFI_DEV_TYPE_I2C, 0, &mxt1666t2_platform_data, NULL},
        {"fts_ts", SFI_DEV_TYPE_I2C, 0, &ft5826s_platform_data, NULL},
...
#ifdef PRJ_FE375CL
	{"hpa02254_batt", SFI_DEV_TYPE_I2C, 1, &gauge_bq27520_get_platform_data, NULL},
	{"smb347_charger", SFI_DEV_TYPE_I2C, 1, &no_platform_data, NULL},
#endif
	/* MSIC subdevices */
	...
	*/
	...
	{"mrfld_lm49453", SFI_DEV_TYPE_IPC, 1, &merfld_audio_platform_data,
						&ipc_device_handler},
	{"mrfld_wm8958", SFI_DEV_TYPE_IPC, 1, &merfld_rt5648_audio_platform_data,
						&ipc_device_handler},
