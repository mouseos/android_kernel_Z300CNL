...
static struct mdm_ctrl_cpu_data cpu_generic = {
	...
	.gpio_sim1_ap_cd_name = GPIO_SIM1_AP_CD,
	.gpio_ap_req_cdump_name = GPIO_AP_REQ_CDUMP,
	.gpio_modem_rsvd_gpio2_name = GPIO_MODEM_RSVD_GPIO2
};
	...
	case CPU_ANNIEDALE:
		{
			...
			cpu_data->gpio_sim1_ap_cd = 113;
			cpu_data->gpio_ap_req_cdump = 51;
			cpu_data->gpio_modem_rsvd_gpio2 = 7;
...
#if 1
	pr_info("Hardcode config name to XMM7260_CONF_9\n");
	strncpy(cfg_name, "XMM_7260", 8);
	strncpy(config_name, "XMM7260_CONF_9", SFI_NAME_LEN - 1);
#else
